...
## 插入SQL
参考[Introduction to MySQL with R](https://programminghistorian.org/en/lessons/getting-started-with-mysql-using-r) 和 [Database Using R](https://db.rstudio.com/getting-started/connect-to-database/)。
